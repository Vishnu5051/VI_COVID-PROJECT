...
/*PREFERENCES STYLE*/
    ...
    .form-all:before {
      content: "";
      background-image: url("https://www.jotform.com/uploads/guest_9378b1e24b97c2c7/form_files/header%20icon2.60d1e1109826c0.54348266.png");
      display: inline-block;
      height: 75px;
      position: absolute;
  ...
  .container{
	...
	background-image: tulip-garden-apr11.png;
...
<form action = "userdetailprocess" method = "POST">
...
<div><form action = "userdetail.php" method = "POST">
<input class="btn btn-outline-primary me-2" type="submit" name="Clear"value="  Reset  "/>
</form></div>
<div><form action = "home.php" method = "POST">
<input class="btn btn-outline-primary me-2" type="submit" name="Home"value="  Home  "/></div>
